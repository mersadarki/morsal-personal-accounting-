...
import { Trash2, Plus, Pencil, Check, X, ChevronDown, ChevronUp, ArrowLeftRight } from 'lucide-react';
    ...
    <div style={{ background: COLORS.surface, border: `1px solid ${COLORS.line}`, borderRadius: 12, marginBottom: 12, overflow: 'hidden' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span role="button" tabIndex={0} aria-label="معکوس کردن طلب/بدهی" title="معکوس کردن — اگه علامتش برعکس ثبت شده" onClick={(e) => { e.stopPropagation(); onFlip(debt.id); }} style={iconBtn(COLORS.brassDark)}><ArrowLeftRight size={13} /></span>
